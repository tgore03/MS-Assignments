...
public class Calculator implements CalculatorConstants {
  ...
  final public void Start() throws ParseException, NumberFormatException {
    ...
    while (true) {
      ...
      jj_consume_token(EOL);
                  System.out.println("Result = " + prevValue + "\u005cn");
    }
    jj_consume_token(0);
  }

  final public int Expression() throws ParseException, NumberFormatException {
        int i;
        int value;
    value = Term();
    label_2:
  ...
  final public int Term() throws ParseException, NumberFormatException {
        int i;
        int value;
    value = Primary();
    label_3:
